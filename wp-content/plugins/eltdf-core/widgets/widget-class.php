 ...
 *
 * Class MrSeoElatedWidget
 */
abstract class MrSeoElatedWidget extends WP_Widget {
    /**
                ...
                switch($param['type']) {
	                ...
	                case 'textarea':
		                ...
		                <p>
			                <label for="<?php echo esc_attr($this->get_field_id($param['name'])); ?>"><?php echo
				                esc_html($param['title']); ?>:</label>
			                <textarea class="widefat" rows="16" cols="20" id="<?php echo esc_attr($this->get_field_id($param['name'])); ?>" name="<?php echo esc_attr($this->get_field_name($param['name'])); ?>"><?php echo mrseo_elated_get_module_part( ${$param['name']} ); ?></textarea>
			                <?php if(!empty($param['description'])) : ?>
				                <span class="eltdf-field-description"><?php echo esc_html($param['description']); ?></span>
			                <?php endif; ?>
		                </p>
