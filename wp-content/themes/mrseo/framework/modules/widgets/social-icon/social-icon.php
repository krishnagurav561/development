...
class MrSeoElatedSocialIconWidget extends MrSeoElatedWidget {
    ...
    public function widget($args, $instance) {
        ...
        <a class="eltdf-social-icon-widget-holder eltdf-icon-has-hover" <?php echo mrseo_elated_get_inline_attr($hover_color, 'data-hover-color'); ?> <?php mrseo_elated_inline_style($icon_styles) ?> href="<?php echo esc_url($link); ?>" target="<?php echo esc_attr($target); ?>">
            <?php echo mrseo_elated_get_module_part( $icon_holder_html ); ?>
        </a>
    <?php
    }
}