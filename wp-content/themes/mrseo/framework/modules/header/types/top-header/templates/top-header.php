<?php
if($show_header_top) {
	do_action('mrseo_elated_before_header_top');
	?>
	...
	<?php if(is_user_logged_in()){
		?>
		<div class="no-top-bar"></div>
		<?php
	}else{
		?>
		<div class="eltdf-top-bar">
			<?php do_action( 'mrseo_elated_after_header_top_html_open' ); ?>
			...
			<?php do_action( 'mrseo_elated_before_header_top_html_close' ); ?>
		</div>
		<?php
	} ?>
	
	
	<?php do_action('mrseo_elated_after_header_top');
}