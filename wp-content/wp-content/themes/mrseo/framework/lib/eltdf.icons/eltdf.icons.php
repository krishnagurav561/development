...
/*
  Class: MrSeoElatedIconCollections
...
class MrSeoElatedIconCollections {
    ...
    private function initIconCollections() {
        $this->addIconCollection('font_awesome', new MrSeoElatedIconsFontAwesome("Font Awesome", "fa_icon"));
        $this->addIconCollection('font_elegant', new MrSeoElatedIconsFontElegant("Font Elegant", "fe_icon"));
	    $this->addIconCollection('ion_icons', new MrSeoElatedIonIcons("Ion Icons", "ion_icon"));
        $this->addIconCollection('linea_icons', new MrSeoElatedLineaIcons('Linea Icons', 'linea_icon'));
    }
    ...
    public function getSocialIconsMetaBoxOrOption($attributes) {
        ...
        if($type == 'meta-box') {
            mrseo_elated_create_meta_box_field(
                array(
                    ...
                    'label' => $label,
                    'options' => array(
                        'font_awesome'      => esc_html__('Font Awesome', 'mrseo'),
                        'font_elegant'      => esc_html__('Font Elegant', 'mrseo'),
                        'ion_icons'         => esc_html__('Ion Icons', 'mrseo')
                    ),
                    'args' => array(
                        'dependence' => true,
        ...
        foreach ($socialIconCollections as $collection_key => $collection_object) {
            ...
            $eltdf_icon_pack_container = mrseo_elated_add_admin_container(
                array(
                    'parent'			=> $parent,
    ...
    public function getVCParamsArray($iconPackDependency = array(), $iconCollectionPrefix = "", $emptyIconPack = false) {
        ...
        $iconPackParams = array(
            'type'        => 'dropdown',
            'heading'     => esc_html__('Icon Pack', 'mrseo'),
    ...
    public function getSocialIconWidgetParamsArray() {
        ...
        $iconPackParams[] = array(
            'type'    => 'dropdown',
            'title'   => esc_html__('Icon Pack', 'mrseo'),
            'name'    => 'icon_pack',
            'options' => array(
                'font_awesome' => esc_html__('Font Awesome', 'mrseo'),
                'font_elegant' => esc_html__('Font Elegant', 'mrseo'),
    ...
    public function getIconCollectionIcons(iMrSeoElatedIconCollection $collection) {
    ...
    public function getSearchIcon($iconPack, $return) {
        ...
        if($this->hasIconCollection($iconPack)) {
            ...
            if($return) {
				...
				echo mrseo_elated_get_module_part( $iconsObject->getSearchIcon() );
            }
        }
    }
    ...
    public function getSearchClose($iconPack, $return) {
        ...
        if($this->hasIconCollection($iconPack)) {
            ...
            if($return) {
				...
				echo mrseo_elated_get_module_part( $iconsObject->getSearchClose() );
            }
        }
    }
    ...
    public function getSearchIconValue($iconPack) {
        ...
        if($this->hasIconCollection($iconPack)) {
            ...
            $iconsObject = $this->getIconCollection($iconPack);
			echo mrseo_elated_get_module_part( $iconsObject->getSearchIconValue() );
        }
    }
    ...
    public function getMenuSideIcon($iconPack) {
        ...
        if($this->hasIconCollection($iconPack)) {
            ...
            $iconsObject = $this->getIconCollection($iconPack);
			echo mrseo_elated_get_module_part( $iconsObject->getMenuSideIcon() );
        }
    }
    ...
    public function getBackToTopIcon($iconPack) {
        ...
        if($this->hasIconCollection($iconPack)) {
            ...
            $iconsObject = $this->getIconCollection($iconPack);
			echo mrseo_elated_get_module_part( $iconsObject->getBackToTopIcon() );
        }
    }
    ...
    public function getMobileMenuIcon($iconPack, $return = false) {
        ...
        if($this->hasIconCollection($iconPack)) {
            ...
            if($return) {
				...
				echo mrseo_elated_get_module_part( $iconsObject->getMobileMenuIcon() );
            }
        }
    }
    ...
    public function getQuoteIcon($iconPack, $return = false) {
        ...
        if($this->hasIconCollection($iconPack)) {
            ...
            if($return == true) {
				...
				echo mrseo_elated_get_module_part( $iconsObject->getQuoteIcon() );
            }
        }
    }
...
if (!function_exists('mrseo_elated_activate_theme_icons')) {
    function mrseo_elated_activate_theme_icons() {
        global $mrseo_elated_IconCollections;
        $mrseo_elated_IconCollections = MrSeoElatedIconCollections::get_instance();
    }

    add_action('after_setup_theme', 'mrseo_elated_activate_theme_icons');
}