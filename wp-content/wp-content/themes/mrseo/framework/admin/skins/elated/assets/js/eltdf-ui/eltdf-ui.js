(function($){
	...
	$(window).load(function () {
		eltdfShowHidePostFormatsGutenberg();
	});

	function eltdfShowHidePostFormatsGutenberg() {
		...
		if(gutenbergEditor.length) {
			...
			gPostFormatField.find('select option').each(function () {
				$('#eltdf-meta-box-post_format_' + $(this).val() + '_meta').hide();
			});

			if (gPostFormatField.find('select option:selected')) {
				$('#eltdf-meta-box-post_format_' + gPostFormatField.find('select option:selected').val() + '_meta').fadeIn();
			}
    ...
    function eltdfInitPortfolioItemsBox() {
        ...
        $('.eltdf-portfolio-add a.eltdf-add-item').on('click',function (event) {
            event.preventDefault();
	...
	function eltdfInitPortfolioImagesVideosBox() {
		...
		$('a.eltdf-add-image').on('click',function (e) {
			e.preventDefault();
		...
		$('a.eltdf-add-video').on('click',function (e) {
			e.preventDefault();
    ...
    */
    ...
    function eltdfInitSlideElementItemsBox() {
        ...
        $('.eltdf-slide-element-add a.eltdf-add-item').on('click',function (event) {
