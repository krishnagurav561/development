                        ...
                        <div class="col-lg-12">
                            <div class="eltdf-media-uploader">
                                <div<?php if (!$has_value) { ?> style="display: none"<?php } ?>
                                    ...
                                    <img src="<?php if ($has_value) { echo esc_url(mrseo_elated_option_get_uploaded_file_icon($value)); } ?>" alt="<?php esc_attr_e('Image1', 'mrseo'); ?>"
                                ...
                                <a class="eltdf-media-upload-btn btn btn-sm btn-primary"
                                   ...
                                   data-frame-title="<?php esc_attr_e('Select File', 'mrseo'); ?>"
