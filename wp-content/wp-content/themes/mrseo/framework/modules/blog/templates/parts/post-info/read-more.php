<?php if ( !strpos( get_the_content(), 'eltdf-more-link-container' )){ //add read more link if there is no continue reading ?>
	...
	<?php
	    if(mrseo_elated_core_plugin_installed()) {
	        ...
	        <a itemprop="url" href="<?php echo esc_url(get_the_permalink()); ?>" target="_self" class="eltdf-btn eltdf-btn-medium eltdf-btn-simple eltdf-btn-icon eltdf-blog-list-button eltdf-btn-hover-unveiling">
