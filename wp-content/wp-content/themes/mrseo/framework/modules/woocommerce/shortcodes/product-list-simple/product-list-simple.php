...
class ProductListSimple implements Lib\ShortcodeInterface {
    ...
    public function vcMap() {
	    if(function_exists('vc_map')) {
		    vc_map(
		    	array(
				    'name'                      => esc_html__( 'Elated Product List - Simple', 'mrseo' ),
				    'base'                      => $this->base,
				    ...
				    'params'                    => array(
					    array(
						    ...
						    'value'      => array(
							    esc_html__( 'Sale', 'mrseo' )         => 'sale',
							    esc_html__( 'Best Sellers', 'mrseo' ) => 'best-sellers',
							    esc_html__( 'Featured', 'mrseo' )     => 'featured'
						    )
					    ),
					    array(
						    'type'        => 'textfield',
						    ...
						    'description' => esc_html__( 'Number of products to show (default value is 4)', 'mrseo' )
					    ),
					    array(
						    'type'        => 'dropdown',
						    'param_name'  => 'order_by',
    ...
    public function render($atts, $content = null){
        ...
        $html = mrseo_elated_get_woo_shortcode_module_template_part('templates/product-list-template', 'product-list-simple', '', $params);
